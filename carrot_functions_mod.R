...
#check that empirical prediction is given for most likely outcome, add for categorical
#make the possibility of handling binary and multin outcome not only as 0/1 etc.
